import mug from "./photos/mug-pc.jpg"
  ...
  return (
    <div className="About" style={{height:"100vh", backgroundImage:`url(${mug})`, paddingTop:"140px"}}>
      <div class="container" style={{marginLeft:"50px"}}>
        <div class="row">
          <div class="col">
            <img src={myPhoto} style={{height:"350px", width:"350px", borderColor:"black", borderStyle:"double", borderRadius:"50px"}}/>
          </div>
          <div class="col">
        ...
        <div class="row">
          ...
          <div class="col-9">
            ...
            <a style={{textDecoration:"none"}} href={cv} target = "_blank">Download CV</a>
          </div>
